...
CFApproxBoundW <- function(sval){
  ...
  wval[sval > 1 & sval <= 3] <- 0.00537*sval[sval > 1 & sval <= 3]^4 -
                                0.06906*sval[sval > 1 & sval <= 3]^3 +
                                 0.3167*sval[sval > 1 & sval <= 3]^2 -
                                0.02326*sval[sval > 1 & sval <= 3]
  wval[sval > 3 & sval <= 40] <- 0.705*sqrt(sval[sval > 3 & sval <= 40])*log(sval[sval > 3 & sval <= 40])
  wval[sval > 40] <- sqrt(sval[sval > 40]*(3*log(sval[sval > 40])) - log(8*pi) - 2 / log(sval[sval > 40]) - 170)
